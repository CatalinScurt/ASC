    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            if (luni == 0 && zile == 0)
                Console.WriteLine("Va fi necesar {0} ani pentru ca puterea de calcul a procesoarelor sa fie de {1} ori mai mare!", ani, n);
            else if (luni ==0)
                Console.WriteLine("Va fi necesar {0} ani si {1} zile pentru ca puterea de calcul a procesoarelor sa fie de {2} ori mai mare!", ani, zile, n);
            else if (zile ==0)
                Console.WriteLine("Va fi necesar {0} ani si {1} luni pentru ca puterea de calcul a procesoarelor sa fie de {2} ori mai mare!", ani, luni, n);
            else
